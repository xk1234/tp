...
public class CommandTestUtil {
    ...
    public static final String VALID_COMMISSION_AMY = "200";
    public static final String VALID_COMMISSION_BOB = "434344";
    ...
    public static final String INVALID_COMMISSION_DESC = " " + PREFIX_COMMISSION + "-1"; // neg int not allowed
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + INVALID_TAG_HUBBY; // '*' not allowed in tags
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withAddress(VALID_ADDRESS_AMY).withCommission(VALID_COMMISSION_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withAddress(VALID_ADDRESS_BOB).withCommission(VALID_COMMISSION_BOB)
