...
* Code and Tests: Used by Xinkang for refactoring, checking, and writing boilerplate
...
**Use case: UC13 - Summarize information about current list of contacts**

**MSS**

1. User requests to see summary information about contacts.
2. AscendNetwork displays summary information about contacts.

Use case ends.

**Use case: UC14 - See the contacts with the highest or lowest commissions**

**MSS**

1. User requests to see the contacts with the highest or lowest commissions.
2. AscendNetwork displays the contacts with the highest or lowest commissions.
...
1. Summarizing statistics when list is empty
   ...
   2. `summary`<br>
       Expected: The output is all 0s for every statistic
