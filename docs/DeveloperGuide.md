...
**`Main`** (consisting of classes [ `Main`](https://github.com/AY2425S2-CS2103T-T14-4/tp/tree/master/src/main/java/seedu/address/Main.java) and [ `MainApp`](https://github.com/AY2425S2-CS2103T-T14-4/tp/tree/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
2. AscendNetwork shows the list of all persons.
   Use case ends.
...
3.  AscendNetwork shows all contacts that passes the filter.
    use case ends.
...
4.  AscendNetwork displays the sorted list of contacts.
    Use case ends.
...
4.  AscendNetwork exports contacts to default file path.
    Use case ends.
...
* **Person/Contact**: An entry in AscendNetwork
